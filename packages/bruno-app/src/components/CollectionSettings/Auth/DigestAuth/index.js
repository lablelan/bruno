...
const DigestAuth = ({ collection }) => {
  ...
  return (
    <StyledWrapper className="mt-2 w-full">
      <label className="block font-medium mb-2">{t('CollectionSettings_Auth_DigestAuth.Username')}</label>
      ...
      <label className="block font-medium mb-2">{t('CollectionSettings_Auth_DigestAuth.Password')}</label>
